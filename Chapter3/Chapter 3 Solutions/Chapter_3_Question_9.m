function Chapter_3_Question_9()
    ...
    % repeats itself from negative to positive infinity seconds. In other words,
    ...
    % fits frequencies to this forever-repeating data. By doubling the data, we
    % are not actually giving the fourier transform more information; it
    % already assumed the data was being repeated forever. So it fits the best
    % frequencies to the data with that assumption. If you look at the values 
    % of Sxx_double, you'll see every other one is 0. This is because the "new"
